	...
	<c:choose>
		...
		<c:when test="${side_menu=='mem_mode' }">
			...
			<ul class="side_ul">		
				...
				<li class="side_li"><a href="${contextPath }/admin/getUserGrade.do" class="side2" onclick="changeStyle(this)">관심 공연</a></li>
				<li class="side_li"><a href="${contextPath }/admin/getUserGrade.do" class="side2" onclick="changeStyle(this)">예매 내역</a></li>
